"""
Standardized API response route handler.

Wraps successful JSON responses in an enterprise envelope:
    { "success": true, "data": ..., "error": null }

Error responses (4xx/5xx) are handled by the exception handlers in
api_contract middleware.
"""
import json
...
class StandardizedResponseRoute(APIRoute):
    ...
    def get_route_handler(self) -> Callable:
        ...
        async def custom_route_handler(request: Request) -> Response:
            ...
            # Status codes 400+ are handled by the global exception handlers
            ...
            try:
                if hasattr(response, "body"):
                    ...
                    # Copy over custom headers (excluding content-length/type)
